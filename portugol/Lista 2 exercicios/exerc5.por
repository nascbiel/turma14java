programa
{
	...
	funcao inicio()
	{
		 ...
		 * as industrias do 1º e 2º grupo são intimadas a suspenderem suas atividades, se o índice 
		 * atingir 0,5 todos os grupos devem ser notificados a paralisarem suas atividades. Faça um sistema 
